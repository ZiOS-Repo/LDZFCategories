...
- (void)viewDidLayoutSubviews {
    ...
    self.appBar.frame = CGRectMake(0, 0, self.view.width, NavigationContentTopConstant);
    self.ldzfView.frame = CGRectMake(0, NavigationContentTopConstant, self.view.width, self.view.height - NavigationContentTopConstant);
}
