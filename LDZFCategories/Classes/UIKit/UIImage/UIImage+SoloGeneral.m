...
@implementation UIImage (SoloGeneral)

- (BOOL)solo_hasAlphaChannel
{
...
- (UIImage *)solo_imageByRotate:(CGFloat)radians fitSize:(BOOL)fitSize
{
...
+ (UIImage *)solo_imageWithSmallGIFData:(NSData *)data scale:(CGFloat)scale {
...
+ (UIImage *)solo_imageWithPDF:(id)dataOrPath {
    return [self p_imageWithPDF:dataOrPath resize:NO size:CGSizeZero];
}

+ (UIImage *)solo_imageWithPDF:(id)dataOrPath size:(CGSize)size {
