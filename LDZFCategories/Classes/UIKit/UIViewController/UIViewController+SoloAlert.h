...
/**
 alert点击
 */
typedef void(^SoloAlertClickIndexBlock)(NSInteger clickNumber);

/**
 alert 取消
 */
typedef void(^SoloAlertCancleBlock)(void);

@interface UIViewController (SoloAlert)
