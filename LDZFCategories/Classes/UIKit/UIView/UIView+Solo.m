...
#import "UIView+Solo.h"

@implementation UIView (Solo)

#pragma mark - General
- (UIImage *)solo_snapshot
{
    /*
...
- (UIImage *)solo_cutoutInViewWithRect:(CGRect)rect
{
...
- (void)solo_addBlurEffectWith:(UIBlurEffectStyle)blurStyle
{
 ...
 */
- (void)solo_addRectCornerWithViewBounds:(CGRect)rect corner:(UIRectCorner)corner radius:(CGFloat)radius
{
...
- (void)solo_addRectCornerWith:(UIRectCorner)corner radius:(CGFloat)radius
{
    [self solo_addRectCornerWithViewBounds:self.bounds corner:corner radius:radius];
}

- (void)solo_addAllCornerWith:(CGFloat)radius
{
    [self solo_addRectCornerWith:UIRectCornerAllCorners radius:radius];
}
- (void)solo_addAllCornerWithViewBounds:(CGRect)rect radius:(CGFloat)radius
{
    [self solo_addRectCornerWithViewBounds:rect corner:UIRectCornerAllCorners radius:radius];
}

- (void)solo_drawDashLineWithpointArray:(NSArray *)pointArr lineWidth:(float)lineWidth lineLength:(float)lineLength lineSpacing:(float)lineSpacing lineColor:(UIColor *)lineColor
{
