...
@implementation UIDevice (SoloGeneral)
...
{
    double total = [self solo_getDiskSpaceTotal];
    double free = [self solo_getDiskSpaceFree];
...
{
    float cpu = 0;
    NSArray *cpus = [UIDevice solo_cpuUsagePerProcessor];
